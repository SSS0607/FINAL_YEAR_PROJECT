<html>
<head><title>Enter Educational Details</title></head>
<body>
...
st.executeUpdate("insert into topres2 values('"+s8+"','"+s9+"','"+s10+"','"+s11+"','"+s12+"','"+s13+"','"+s14+"','"+s15+"','"+s16+"','"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"')");
      
       %>
       <form action="top3.jsp" method="post">
...
<tr>
<td>Enter the Job you have applied for(Conformation)</td>
 
<td>
<input type="text" name="topjob" maxlength="100" placeholder="Enter your job name here..." /required>
</td>
</tr>
